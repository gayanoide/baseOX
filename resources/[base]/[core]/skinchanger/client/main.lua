local Components = {
	...
	{label = _U('pants_1'),					name = 'pants_1',			value = 0,		min = 0,	zoomOffset = 1.0,		camOffset = -0.5},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 1.0,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 0,		min = 0,	zoomOffset = 1.0,		camOffset = -0.8},
	{label = _U('shoes_2'),					name = 'shoes_2',			value = 0,		min = 0,	zoomOffset = 1.0,		camOffset = -0.8,	textureof	= 'shoes_1'},
...
for i=1, #Components2, 1 do
	CharacterJob[Components2[i].name] = Components2[i].value
end
...
AddEventHandler('skinchanger:getSkinJob', function(cb)
	cb(CharacterJob)
end)
